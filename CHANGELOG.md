...
Removed the abandoned `MediateX.SourceGenerator` spike (`0.1.0-spike`) and the supporting `MediateX.Examples.SourceGenerator` sample, plus the related research notes and planning specs. No runtime change vs v3.3.0; the main `MediateX` package is functionally identical.

**Removed:**
- `src/MediateX.SourceGenerator/` (project + generator)
- `samples/MediateX.Examples.SourceGenerator/` (sample app)
- `docs/research/` (investigation notes: AOT, source generators, evolution roadmap, v3.1/v4.0 plans, documentation review)
- `specs/planned/source-generator-v4.md`
