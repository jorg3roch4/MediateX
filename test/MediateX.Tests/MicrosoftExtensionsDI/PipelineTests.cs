...
namespace MediateX.Extensions.Microsoft.DependencyInjection.Tests;
...
public class PipelineTests
{
    ...
    public async Task Should_register_correctly()
    {
        ...
        services.AddSingleton(new MediateX.Tests.PipelineTests.Logger());
        services.AddSingleton(new MediateX.Tests.StreamPipelineTests.Logger());
        services.AddSingleton(new MediateX.Tests.SendTests.Dependency());
