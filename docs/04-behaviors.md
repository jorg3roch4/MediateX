...
MediateX focuses on core mediator functionality. For cross-cutting concerns, use dedicated libraries:

- **Validation**: [FluentValidation](https://fluentvalidation.net/)
- **Resilience (retry, timeout)**: [Polly](https://github.com/App-vNext/Polly) or [Microsoft.Extensions.Resilience](https://learn.microsoft.com/en-us/dotnet/core/resilience/)
- **Result types**: [FluentResults](https://github.com/altmann/FluentResults), [ErrorOr](https://github.com/amantinband/error-or), or [OneOf](https://github.com/mcintyre321/OneOf)
