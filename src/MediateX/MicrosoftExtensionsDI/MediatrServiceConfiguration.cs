...
using MediateX;
using MediateX.Entities;
using MediateX.NotificationPublishers;
using MediateX.Pipeline;
...
public class MediatRServiceConfiguration
{
    ...
    /// <summary>
    /// Configure the Maximum Amount of Generic RequestHandler Types Nexar will try to register.  To Disable this constraint, set the value to 0.
    /// </summary>
    ...
    /// <summary>
    /// Flag that controlls whether Nexar will attempt to register handlers that containg generic type parameters.
    /// </summary>
